...
function initialize(id) {
    ...
    var overlayTitle = 'Las Mejores Hamburguesas de Caracas';

    var locations = [
        //point number 1
        ['Hamburgueseria212', 'Centro Comercial Plaza Las Américas, Boulevard El Cafetal, Caracas, Venezuela', 10.459095, -66.829381]
    ];
